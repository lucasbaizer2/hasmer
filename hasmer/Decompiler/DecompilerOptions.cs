...
namespace Hasmer.Decompiler {
    ...
    public struct DecompilerOptions {
        /// <summary>
        /// The default decompiler options.
        /// </summary>
        public static readonly DecompilerOptions Default = new DecompilerOptions {
            OmitPrototypeFromConstructorInvocation = false,
            OmitThisFromFunctionInvocation = true,
            OmitExplicitGlobal = false
        };
